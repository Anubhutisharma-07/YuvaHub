...
export const ObservabilityMetricsCard: React.FC<Props> = ({ healthScore, metrics }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
      ...
      <div className="p-6 bg-slate-900 border border-slate-800 rounded-3xl flex flex-col items-center justify-center text-center shadow-lg relative overflow-hidden">
      ...
      <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-5 bg-slate-900/60 border border-slate-800 rounded-3xl flex flex-col justify-between">
          ...
          <div className="mt-4">
            <div className="text-xs font-bold uppercase text-slate-400 tracking-wider">Avg 24h Uptime</div>
            <div className="text-2xl font-black text-white mt-1">{avgUptime}%</div>
          </div>
          <div className="mt-3 text-xs text-slate-400 border-t border-slate-800/80 pt-2 flex justify-between">
            <span>SLA Floor</span>
        ...
        <div className="p-5 bg-slate-900/60 border border-slate-800 rounded-3xl flex flex-col justify-between">
          <div className="flex justify-between items-start">
            ...
            <span className="text-xs font-bold px-2 py-1 rounded-full bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">
              P95 Window
            </span>
          </div>
          <div className="mt-4">
            <div className="text-xs font-bold uppercase text-slate-400 tracking-wider">Mean Latency</div>
        ...
        <div className="p-5 bg-slate-900/60 border border-slate-800 rounded-3xl flex flex-col justify-between">
          <div className="flex justify-between items-start">
            <div className={`p-2.5 rounded-2xl border ${
              Number(avgErrorRate) > 1 ? 'bg-rose-500/10 text-rose-400 border-rose-500/20' : 'bg-amber-500/10 text-amber-400 border-amber-500/20'
            }`}>
          ...
          <div className="mt-4">
            <div className="text-xs font-bold uppercase text-slate-400 tracking-wider">Error Rate</div>
