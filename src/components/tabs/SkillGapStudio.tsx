...
export default function SkillGapStudio() {
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto w-full max-w-6xl mx-auto space-y-6 pb-20">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">AI Skill Gap Analyzer</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400">Discover what skills you're missing for a specific opportunity and get a personalized roadmap.</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex border-b border-gray-200 dark:border-gray-700">
        <button
          ...
          className={`pb-3 px-4 font-medium text-sm transition-colors relative ${activeTab === 'analyzer' ? 'text-blue-600 dark:text-blue-400' : 'text-gray-500 hover:text-gray-900 dark:hover:text-gray-300'}`}
        >
        ...
        <button
          ...
          className={`pb-3 px-4 font-medium text-sm transition-colors relative ${activeTab === 'history' ? 'text-blue-600 dark:text-blue-400' : 'text-gray-500 hover:text-gray-900 dark:hover:text-gray-300'}`}
        >
          <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
              <h3 className="text-md font-bold text-gray-900 dark:text-white">Target Opportunity</h3>
              ...
              <div>
                <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Opportunity ID (Optional)</label>
                <input 
                  type="text" 
                  placeholder="e.g. 64d9f..."
                  value={opportunityId}
                  onChange={e => setOpportunityId(e.target.value)}
                  className="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all dark:text-white"
                />
              </div>
              ...
              <div>
                <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Job / Opportunity Description</label>
                <textarea 
                  rows={6}
                  placeholder="Paste the job description here..."
                  value={opportunityDescription}
                  onChange={e => setOpportunityDescription(e.target.value)}
                  className="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all resize-none dark:text-white"
                />
              </div>
          ...
          <div className="lg:col-span-2">
            {!analysisResult && !isAnalyzing && (
              <div className="h-full bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 flex items-center justify-center p-8">
                <EmptyState 
            ...
            {isAnalyzing && (
              <div className="h-full bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 flex flex-col items-center justify-center min-h-[400px]">
                ...
                <h3 className="mt-4 text-lg font-bold text-gray-900 dark:text-white">AI is evaluating your profile...</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md text-center mt-2">
            ...
            {analysisResult && !isAnalyzing && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* Radial Progress */}
                  <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm flex items-center">
                    <div className="w-32 h-32 shrink-0">
                      ...
                      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                        <span className="text-2xl font-bold text-gray-900 dark:text-white">{analysisResult.matchPercentage}%</span>
                        <span className="text-[10px] uppercase font-bold text-gray-500">Fit</span>
                      </div>
                    </div>
                    <div className="ml-6">
                      <h3 className="text-lg font-bold text-gray-900 dark:text-white">Readiness Score</h3>
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Based on your current profile and roadmap progress, this is how well you match the opportunity.</p>
                    </div>
                  </div>

                  {/* Skills Summary */}
                  <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm flex flex-col justify-center">
                    <h3 className="text-sm font-bold text-gray-900 dark:text-white mb-3">Skills Overview</h3>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center text-sm">
                        <span className="text-gray-500 dark:text-gray-400">Existing Skills</span>
                      ...
                      <div className="flex justify-between items-center text-sm">
                        <span className="text-gray-500 dark:text-gray-400">Missing Skills</span>
                ...
                {analysisResult.missingSkills?.length > 0 && (
                  <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm">
                    <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center gap-2 bg-gray-50/50 dark:bg-gray-800/50">
                      <TrendingUp className="w-4 h-4 text-amber-500" />
                      <h3 className="text-sm font-bold text-gray-900 dark:text-white">Skills to Acquire</h3>
                    </div>
                    <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-3">
                      {analysisResult.missingSkills.map((skill: any, i: number) => (
                        <div key={i} className="p-3 rounded-xl border border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
                          <div className="flex items-center justify-between mb-1">
                            <span className="font-semibold text-gray-900 dark:text-white text-sm">{skill.skill}</span>
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400">{skill.reason}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                {analysisResult.roadmap?.length > 0 && (
                  <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm">
                    <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center gap-2 bg-gray-50/50 dark:bg-gray-800/50">
                      ...
                      <h3 className="text-sm font-bold text-gray-900 dark:text-white">Learning Roadmap</h3>
                    </div>
                        ...
                        {analysisResult.roadmap.map((item: any, i: number) => (
                          <div key={i} className="relative pl-6 md:pl-8">
                            <button 
                              ...
                              className={`absolute -left-[17px] top-0.5 w-8 h-8 rounded-full border-2 flex items-center justify-center transition-colors bg-white dark:bg-gray-800 cursor-pointer ${
                                item.completed 
                            ...
                            <div className={`p-4 rounded-xl border transition-all ${
                              ...
                              <div className="flex flex-col md:flex-row md:items-start justify-between gap-2 mb-3">
                                <div>
                                  <h4 className={`text-base font-bold ${item.completed ? 'text-gray-500 dark:text-gray-400 line-through' : 'text-gray-900 dark:text-white'}`}>
                                    {item.skill}
                                  </h4>
                              ...
                              <div className="space-y-3 mt-3 pt-3 border-t border-gray-100 dark:border-gray-700/50">
                                {item.project && (
                                  <div>
                                    <span className="text-xs font-bold text-gray-700 dark:text-gray-300 block mb-1">Project Idea:</span>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">{item.project}</p>
                                  </div>
                                )}
                                
                                {item.resources?.length > 0 && (
                                  <div>
                                    <span className="text-xs font-bold text-gray-700 dark:text-gray-300 block mb-1">Resources:</span>
                                    <ul className="space-y-1">
                                      {item.resources.map((res: string, idx: number) => (
                                        <li key={idx} className="flex items-start gap-1.5 text-sm text-gray-600 dark:text-gray-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {loadingHistory ? (
            ...
            history.map((item, idx) => (
              <div key={item._id} className="bg-white dark:bg-gray-800 rounded-2xl p-5 border border-gray-200 dark:border-gray-700 shadow-sm flex flex-col hover:border-blue-300 transition-colors cursor-pointer" onClick={() => {
                ...
                <div className="mt-auto space-y-2">
                  <div className="flex items-center justify-between text-xs text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/50 p-2 rounded-lg">
                ...
                <div className="mt-4 pt-3 border-t border-gray-100 dark:border-gray-700 flex items-center justify-center text-sm font-semibold text-blue-600 dark:text-blue-400">
