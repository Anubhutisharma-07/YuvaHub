      ...
      <div className="p-6 bg-slate-900 border border-slate-800 rounded-3xl space-y-6">
        <div className="flex justify-between items-center border-b border-slate-800 pb-4">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">Enterprise contractual SLA compliance levels.</p>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-baseline">
            <span className="text-xs font-bold uppercase text-slate-400 tracking-wider">Current Month-to-Date Uptime</span>
      ...
      <div className="p-6 bg-slate-900 border border-slate-800 rounded-3xl space-y-6">
        <div className="flex justify-between items-center border-b border-slate-800 pb-4">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">Allowed error budget consumption tracking.</p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-4 rounded-2xl bg-slate-950/60 border border-slate-800/80 space-y-1">
            <div className="text-[11px] font-bold uppercase text-slate-400">Remaining Error Budget</div>
            <div className="text-2xl font-black text-emerald-400">{sla.errorBudgetRemaining}%</div>
            <p className="text-[10px] text-slate-500">43 mins downtime remaining</p>
          </div>

          <div className="p-4 rounded-2xl bg-slate-950/60 border border-slate-800/80 space-y-1">
            <div className="text-[11px] font-bold uppercase text-slate-400">Current Burn Rate</div>
            <div className="text-2xl font-black text-amber-400">{sla.burnRate}x</div>
            <p className="text-[10px] text-slate-500">Normal range: &lt; 1.0x</p>
          </div>
        </div>
      </div>
    </div>
